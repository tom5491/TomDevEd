...
import topojsonclientminjs from '@salesforce/resourceUrl/topojsonclientminjs';
import highmapsjs from '@salesforce/resourceUrl/highmapsjs';
import exportingjs from '@salesforce/resourceUrl/exportingjs';
import datajs from '@salesforce/resourceUrl/datajs';

export default class GlobeComponent extends LightningElement {
    
    topojsonclientminjsVar = topojsonclientminjs;
    ...
    renderedCallback() {
        ...
        Promise.all([
            loadScript(this, topojsonclientminjs),
            loadScript(this, highmapsjs),
            loadScript(this, exportingjs),
            loadScript(this, datajs),
        ...
        const data = [
          ...
          Highcharts.getJSON(
            ...
            topology => {
              ...
              const chart = Highcharts.mapChart('world-container', {
                chart: {
                  map: geojson
                },
